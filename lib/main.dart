...
class _HomePageState extends State<HomePage> {
  late String arg = (Get.arguments == null)? "" : Get.arguments;
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          arg.isEmpty? SizedBox(height: 0,) :
          Text(arg),
          SizedBox(height: 20,),
          ElevatedButton(
            onPressed: () {
              Get.to(() => SecondPage(), arguments: 'Rakha Galih');
            },
    ...
    return  Scaffold(
      ...
      body : Center(
        child: Column(
          ...
          children: [
            Text(arg.isEmpty? "Empty" : arg),
            SizedBox(height: 20,),
            ElevatedButton(
              onPressed: () {
                Get.off(() => HomePage(), arguments: 'Anniza Menia');
              },
              child: const Text('Pindah ke halaman sebelumnya'),
            ),
          ],
        ),
      ),
